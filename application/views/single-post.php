		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"><font color="white">Talent2Jeunes</font> <!--<img src="images/logo.png" alt="company logo"/>--></a>
				</div>
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="<?php echo site_url('welcome/single');?>">Single</a></li>
					</ul>
				</div>
			</div>
		</nav>
	    ...
	    <div class="container blog singlepost">
			<div class="row">
				<article class="col-md-8">
			        ...
			        <img src="<?php echo base_url('assets/images/unsplash1.jpg') ?>" class="img-responsive" alt="photo" />
			        <hr>
					<div class="row">
						<div class="col-md-12">
			        ...
			        <div class="comments1">
						...
						<div class="media">
							<a class="pull-left" href="#">
							 	<img class="media-object" src="<?php echo base_url('assets/images/avatar1.png') ?>" alt="">
							</a>
							...
							<div class="row">
								...
								<div class="col-md-12 height-contact-element">    
									<div class="form-group">
										...
										<span class="text">jasonmoussa006@gmail.com/span>
									</div>
								</div>
							</div>
						</div>
