		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"><font color="#FFF">Talent2Jeiunes</font> <!-- <img src="images/logo.png" alt="company logo"/>--></a>
				</div>
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li><a href="blog.php#contact">Contact</a></li>
						<li class="active"><a href="<?php echo site_url('welcome/blog');?>">Blog</a></li>
		        ...
		        <div class="col-md-8">
		                ...
		                <div class="col-sm-4 col-md-4 ">
		                    <div class="blog-thumb">
		                        <a href="single-post.html">
		                            <img class="img-responsive" src="<?php echo base_url('assets/images/blog-photo1.jpg') ?>" alt="photo">
		                        </a>
		                    </div>
		                </div>
		            ...
		            <div class="row">
		                <div class="col-sm-4 col-md-4">
		                    <div class="blog-thumb">
		                        <a href="single-post.html">
		                            <img class="img-responsive" src="<?php echo base_url('assets/images/blog-photo2.jpg') ?>" alt="photo">
		                        </a>
		                    </div>
		                </div>
		                <div class="col-sm-8 col-md-8">
		            ...
		            <div class="row">
		                <div class="col-sm-4 col-md-4">
		                    <div class="blog-thumb">
		                        <a href="single-post.html">
		                        <img class="img-responsive" src="<?php echo base_url('assets/images/blog-photo3.jpg') ?>" alt="photo">
		                        </a>
		                    </div>
		                </div>
		                <div class="col-sm-8 col-md-8">
		            ...
		            <aside class="col-md-4 sidebar-padding">
		                ...
		                <div class="blog-sidebar">
		                    ...
		                    <ul class="sidebar-list">
		                    	<li><a href="#">News & événéments</a></li>
		                        <li><a href="#">Vies & Expérience</a></li>
		                        <li><a href="#">Citation</a></li>
		                        <li><a href="#">Conseils & Entrepreunariat</a></li>
		                        <li><a href="#">Incroyable talent de la RDC</a></li>
		                ...
		                <div class="blog-sidebar">
		                    ...
		                    <div class="media">
		                        <a class="pull-left" href="#">
		                            <img class="img-responsive media-object" src="<?php echo base_url('assets/images/blog1.jpg') ?>" alt="Media Object">
		                        </a>
		                    ...
		                    <div class="media">
		                        <a class="pull-left" href="#">
		                            <img class="img-responsive media-object" src="<?php echo base_url('assets/images/blog2.jpg') ?>" alt="Media Object">
		                        </a>
		                        <div class="media-body">
		                    ...
		                    <div class="media">
		                        <a class="pull-left" href="#">
		                            <img class="img-responsive media-object" src="<?php echo base_url('assets/images/blog3.jpg') ?> " alt="Media Object">
		                        </a>
		                        <div class="media-body">
